...
function Main({ Profile1 }) {
  ...
  const handleProjectLeave = (id) => {
    document.getElementById(id)?.classList.remove('slide-active');
  };
  ...
  return (
    <div 
      className="main-container w-full min-h-screen transition-colors duration-500"
      style={{ 
    ...
    >
      ...
      <div className="flex flex-wrap gap-4">
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="px-6 py-3 bg-orange-500 text-white rounded-lg shadow-lg hover:shadow-xl transition-all"
        >
 ...
 <div className="relative w-64 h-64 md:w-80 md:h-80 mt-10 md:mt-0 flex items-center justify-center group perspective-1000">
  {/* Background Glow */}
  <div className="absolute w-full h-full rounded-full bg-gradient-to-r from-orange-400 to-pink-600 blur-2xl opacity-30 z-0"></div>

  {/* Image with Spinner Effect */}
  <img
    src={bg1}
    alt="Abhishek Gour"
    className="relative z-10 w-full h-full rounded-full object-cover border-4 border-white dark:border-gray-800 shadow-2xl transition-transform duration-700 transform-style-preserve-3d backface-hidden group-hover-rotate-y-360"
  />
</div>
  ...
  <i className={`fa-brands ${skill.icon} text-xl text-orange-500`}></i>
    ...
    {/* Center text */}
    <div className="absolute inset-16 rounded-full bg-gradient-to-br from-orange-400 to-pink-600 flex items-center justify-center shadow-xl">
      ...
      >
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-2">My Awesome</h2>
            <h3 className="text-2xl md:text-3xl text-orange-500">Services</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Service Card 1 */}
            <motion.div 
              className="service-card p-8 rounded-xl shadow-lg hover:shadow-xl transition-all"
              style={{
      ...
      <>
          ...
          >
            {projects.map((project) => (
              <SwiperSlide key={project.id}>
                <div className="relative h-96 rounded-xl overflow-hidden cursor-pointer group shadow-lg transition-all duration-300">
                  {/* Project Image */}
                  <img
                    ...
                    <div className="flex justify-between items-end">
                      ...
                      {project.link && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex items-center justify-center w-10 h-10 bg-orange-500 rounded-full hover:bg-orange-600 transition-all transform group-hover:scale-110"
                  ...
                  {/* Hover Overlay (Additional Effects) */}
                  <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                    {project.github && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="bg-black/80 rounded-full p-3 mx-2 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300 hover:bg-black"
                        title="View Code"
                      >
        ...
        <div className="text-center mt-12">
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="px-8 py-3 bg-orange-500 text-white rounded-lg shadow-lg hover:shadow-xl hover:bg-orange-600 transition-all"
          >
      ...
      >
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h3 className="text-2xl md:text-3xl text-orange-500">Contact Me</h3>
            <div className="w-20 h-1 bg-orange-500 mx-auto mt-4"></div>
          </div>
...
>
  ...
  <div className="mb-4">
    ...
    <div className="relative">
      ...
      <input 
        type="text" 
        name="name"
        className="w-full pl-12 pr-4 py-2 border rounded focus:outline-none dark:bg-gray-700 dark:border-gray-600"
  ...
  <div className="mb-4">
    ...
    <textarea 
      name="description"
      className="w-full p-3 border rounded focus:outline-none dark:bg-gray-700 dark:border-gray-600"
      rows="5"
  ...
  <motion.button
    ...
    whileTap={{ scale: 0.98 }}
    className="w-full py-3 bg-orange-500 text-white rounded-lg shadow hover:shadow-md transition-all"
  >
    Send Message
  </motion.button>
</form>
