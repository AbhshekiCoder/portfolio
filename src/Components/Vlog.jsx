      ...
      <section className={`mt-20 px-5 py-10 ${themeColors.expertiseBg}`}>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            ...
            { label: "Vanilla JavaScript", width: 90 },
            { label: "React", width: 90 },
            { label: "Node.js", width: 70 },
            { label: "Express", width: 90 },
            { label: "MongoDB", width: 90 },
            { label: "PHP", width: 90 },
            { label: "Tailwind CSS", width: 40 },
            { label: "Bootstrap", width: 50 },
